...
public class ThirdPersonControl : MonoBehaviour
{
    ...
    [SerializeField] bool enableCinemachineAdjust = false;
    ...
    [SerializeField] float standCenter = 0.8635731f;
    [SerializeField] float crouchCenter = 0.6873827f;
    ...
    #region Cinemachine Adjustment Variables
    [Header("Cinemachine Adjustment")]
    [SerializeField] CinemachineVirtualCameraBase cinemachineCam;
    [SerializeField] Transform regularTarget;
    [SerializeField] Transform sprintTarget;
    #endregion
    ...
    void GetMoveInput()
    {
        ...
        //AnimationStrafeBlendSnapping(transform.InverseTransformDirection(moveDir));
    }
    ...
    void ApplyCrouch(bool fromJump = false) //applies crouch movement
    {
    ...
    void AnimationSprintBlend(float movement)
    {
        ...
        if (movement > 1)
        {
            if (sprintOn)
            {
                if (enableCinemachineAdjust) cinemachineCam.LookAt = sprintTarget;
            ...
            else
            {
                ...
                if (enableCinemachineAdjust) cinemachineCam.LookAt = regularTarget;
    ...
    void AnimationStrafeBlendSnapping(Vector3 vector)
    {
        anim.SetFloat("MoveX", (float)System.Math.Round(vector.x, 2));
        anim.SetFloat("MoveZ", (float)System.Math.Round(vector.z, 2));
    }
